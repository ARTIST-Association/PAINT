...
def deflectometry_item_data() -> tuple[str, pd.Series]:
    ...
    data = {
        ...
        "CreatedAt": "2023-09-18T11:39:25Z",
        "FileCreatedAt": "2023-09-18T11-39-25Z",
    }
...
def deflectometry_collection_data() -> pd.DataFrame:
    ...
    data = {
        ...
        "title": [
            "Deflectometry measurements for AY39 at 2023-09-18T11:39:25Z",
            "Deflectometry measurements for AY39 at 2024-09-18T11:39:25Z",
            "Deflectometry measurements for AY39 at 2022-06-26T07:07:07Z",
        ],
        "url": [
            "INSERT/SOMETHING/HERE/AY39-2023-09-18T11-39-25Z-deflectometry-item-stac.json?download=1",
            "INSERT/SOMETHING/HERE/AY39-2024-09-18T11-39-25Z-deflectometry-item-stac.json?download=1",
            "INSERT/SOMETHING/HERE/AY39-2023-06-26T07-07-07Z-deflectometry-item-stac.json?download=1",
        ],
        "CreatedAt": [
            "2023-09-18T11:39:25Z",
            "2024-09-18T11:39:25Z",
            "2022-06-26T07:07:07Z",
        ],
    ...
    for heliostat, data in deflectometry_collection_data.groupby(mappings.HELIOSTAT_ID):
        ...
        expected = {
            ...
            "extent": {
                ...
                "temporal": {
                    "interval": [["2022-06-26T07:07:07Z", "2024-09-18T11:39:25Z"]]
                },
            },
            "summaries": {
                "datetime": {
                    "minimum": "2022-06-26T07:07:07Z",
                    "maximum": "2024-09-18T11:39:25Z",
                },
            ...
            "links": [
                ...
                {
                    "rel": "item",
                    "href": "INSERT/SOMETHING/HERE/AY39-2023-09-18T11-39-25Z-deflectometry-item-stac.json?download=1",
                    "type": "application/geo+json",
                    "title": "STAC item of Deflectometry measurements for AY39 at 2023-09-18T11:39:25Z",
                },
                {
                    "rel": "item",
                    "href": "INSERT/SOMETHING/HERE/AY39-2024-09-18T11-39-25Z-deflectometry-item-stac.json?download=1",
                    "type": "application/geo+json",
                    "title": "STAC item of Deflectometry measurements for AY39 at 2024-09-18T11:39:25Z",
                },
                {
                    "rel": "item",
                    "href": "INSERT/SOMETHING/HERE/AY39-2023-06-26T07-07-07Z-deflectometry-item-stac.json?download=1",
                    "type": "application/geo+json",
                    "title": "STAC item of Deflectometry measurements for AY39 at 2022-06-26T07:07:07Z",
                },
            ],
        }
...
def test_make_deflectometry_item(
    ...
    expected = {
        "stac_version": "1.0.0",
        "stac_extensions": [],
        "id": "AY39-2023-09-18T11-39-25Z-deflectometry",
        "type": "Feature",
        ...
        "geometry": {
            "type": "Point",
            "coordinates": [50.91481106887017, 6.388024024804218, 88.66962],
        },
        "bbox": [
            50.91481106887017,
            6.388024024804218,
        ...
        "properties": {
            "datetime": "2023-09-18T11:39:25Z",
            "instruments": "QDec_2014-101",
        },
        "links": [
            {
                "rel": "self",
                "href": "https://paint-database.org/WRI1030197/AY39/Deflectometry/AY39-2023-09-18T11-39-25Z-deflectometry-stac.json",
                "type": "application/geo+json",
        ...
        "assets": {
            "raw_measurement": {
                "href": "https://paint-database.org/WRI1030197/AY39/Deflectometry/AY39-2023-09-18T11-39-25Z-deflectometry.h5",
                "roles": ["data"],
                "type": "application/x-hdf5",
                "title": "Raw deflectometry measurement of AY39 at 2023-09-18T11:39:25Z",
                "created": "2023-09-18T11:39:25Z",
            },
            "filled_measurement": {
                "href": "https://paint-database.org/WRI1030197/AY39/Deflectometry/AY39-filled-2023-09-18T11-39-25Z-deflectometry.h5",
                "roles": ["data"],
                "type": "application/x-hdf5",
                "title": "Filled deflectometry measurement of AY39 at 2023-09-18T11:39:25Z",
                "created": "2023-09-18T11:39:25Z",
            },
            "results_summary": {
                "href": "https://paint-database.org/WRI1030197/AY39/Deflectometry/AY39-2023-09-18T11-39-25Z-deflectometry-result.pdf",
                "roles": ["metadata"],
                "type": "application/pdf",
                "title": "Summary of deflectometry measurement of AY39 at 2023-09-18T11:39:25Z",
                "created": "2023-09-18T11:39:25Z",
            },
        },
    }
