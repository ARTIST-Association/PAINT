...
df_measurements["Month"], df_measurements["Hour"] = (
    df_measurements["CreatedAt"].dt.month,
    df_measurements["CreatedAt"].dt.hour,
)

# Calculate Azimuth and Elevation
df_measurements["Azimuth"], df_measurements["Elevation"] = calculate_az_el(
    df_measurements
)
