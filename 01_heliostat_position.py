...
highlighted_heliostats = df_deflectometry.index[df_deflectometry['DeflectometryAvailable'] == True].tolist()
...
for color, label in percentage_labels.items():
    ...
    plt.plot(subset['x'], subset['y'], 'o', markerfacecolor='none', markeredgecolor=color, markersize=7, label=label)
